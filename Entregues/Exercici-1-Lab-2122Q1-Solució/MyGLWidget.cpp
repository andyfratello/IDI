...
const glm::vec3 MyGLWidget::colorCopa(0.0, 0.5, 0.0);
...
void MyGLWidget::creaBuffersTronc ()
{
  ...
  glm::vec3 Col[6] = {
    colorTronc, colorTronc, colorTronc, colorTronc, colorTronc, colorTronc
  };
...
void MyGLWidget::creaBuffersCopa ()
{
  ...
  glm::vec3 Col[6] = {
    colorArbre[i], colorArbre[i], colorArbre[i], colorArbre[i], colorArbre[i], colorArbre[i]
  };
  ...
  if (tipus) {
   // glm::vec3 Vertices[3];  // Quatre vèrtexs amb X, Y i Z
    ...
    Vertices[3] = glm::vec3( 0, 0.8, 0);
    Vertices[4] = glm::vec3(-0.4, -0.4, 0);
    Vertices[5] = glm::vec3( 0.4, -0.4, 0);
  } else {
    //glm::vec3 Vertices[6];  // Quatre vèrtexs amb X, Y i Z
    Vertices[0] = glm::vec3( 0.5,  0.8, 0);
    Vertices[1] = glm::vec3(-0.5,  0.8, 0);
    Vertices[2] = glm::vec3(-0.5, -0.2, 0);
    Vertices[3] = glm::vec3( 0.5, -0.2, 0);
    Vertices[4] = glm::vec3( 0.5,  0.8, 0);
    Vertices[5] = glm::vec3(-0.5, -0.2, 0);
  } 
